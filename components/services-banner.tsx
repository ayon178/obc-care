...
export default function ServicesBanner() {
  ...
  return (
    <section className="relative h-screen min-h-[600px] w-full overflow-hidden">
      <Image
        src="/services/banner.jpg" // Using existing image path
        alt="Services Banner"
        fill
        ...
        priority
      />
      {/* gradient overlays - matching industries-banner style */}
      ...
      <div className="container relative z-10 mx-auto h-full px-4 sm:px-6 lg:px-8">
        <div className="flex h-full items-center justify-end pt-32 md:pt-36">
          ...
          >
            ...
            >
              {t.rich("title", {
                green: (chunks) => <span className="text-[#91C73E]">{chunks}</span>
              })}
            </motion.h1>
            <motion.p
