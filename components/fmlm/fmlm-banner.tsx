...
export default function FmlmBanner() {
  return (
    <section
      ...
      style={{
        backgroundImage: "url('https://images.unsplash.com/photo-1601581875101-85c47016a1c2?q=80&w=2070&auto=format&fit=crop')",
        ...
        <div className="flex h-full items-center justify-end pt-32 md:pt-36">
          ...
          >
            ...
            <p className="paragraphFont mt-2 text-white/95 text-[11px] sm:text-xs md:text-sm max-w-2xl drop-shadow-lg text-right ml-auto">
              Seamless ground transport connecting airports, warehouses, and destinations
              with speed, precision, and 24/7 availability — worldwide.
            </p>
