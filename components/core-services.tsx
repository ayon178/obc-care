          ...
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Main Card */}
                <div className="relative h-full p-6 md:p-10 bg-white/90 backdrop-blur-xl rounded-3xl shadow-xl border-2 border-gray-200/50 group-hover:border-gray-300/60 transition-all duration-500 overflow-hidden">
