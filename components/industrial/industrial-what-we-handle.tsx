...
const items = [
  {
    icon: Cog,
    title: "Heavy Machinery Parts & Equipment",
    color: "#194479",
  },
  {
    icon: Wrench,
    title: "Maintenance, Repair & Operations (MRO) Components",
    color: "#91c73e",
  },
  {
    icon: Settings,
    title: "Industrial Tools & Calibration Instruments",
    color: "#194479",
  },
  {
    icon: Factory,
    title: "Manufacturing Line Replacements",
    color: "#91c73e",
  },
  {
    icon: Package,
    title: "Oversized or Custom-Engineered Components",
    color: "#194479",
  },
]
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="paragraphFont text-gray-700 text-sm md:text-base max-w-2xl mx-auto">
            Comprehensive logistics for every industrial component your operations need.
          </p>
        </motion.div>
