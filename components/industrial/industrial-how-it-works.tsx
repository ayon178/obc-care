...
const steps = [
  {
    ...
    desc: "Our logistics control team identifies the fastest route and optimal transport method.",
    icon: Radio,
    color: "#194479",
  },
  {
    number: "02",
    title: "Specialized Packaging & Handling",
    desc: "Industrial cargo is secured with vibration-resistant, moisture-proof, or custom crating as needed.",
    icon: Package,
    color: "#91c73e",
  },
  {
    ...
    desc: "Urgent parts are shipped on the next available flight or escorted by an Onboard Courier (OBC).",
    icon: Plane,
    color: "#194479",
  },
  {
    ...
    desc: "We handle all trade documents and ensure full compliance with import/export and safety standards.",
    icon: FileCheck,
    color: "#91c73e",
  },
  {
    ...
    desc: "Fast and verified delivery to your plant, job site, or engineering facility.",
    icon: Building2,
    color: "#194479",
  },
]
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="paragraphFont text-gray-700 text-sm md:text-base max-w-2xl mx-auto">
            A streamlined 5-step process ensuring your industrial components reach your facility safely and on time.
          </p>
        </motion.div>
