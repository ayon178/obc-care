...
const industriesData = [
  {
    icon: Plane,
    color: "#375170ff",
    gradient: "from-[#375170ff]/10 to-[#1a4a7f]/90",
    image: "/industries/aog_part.png",
  },
  {
    icon: Car,
    color: "#9ec06cff",
    gradient: "from-[#9ec06cff]/10 to-[#7bb033]/90",
    image: "/industries/automotive.png",
  },
  {
    icon: Cpu,
    color: "#194479",
    gradient: "from-[#194479]/10 to-[#1a4a7f]/90",
    image: "/industries/electronics.png",
  },
  {
    icon: Cog,
    color: "#9ec06cff",
    gradient: "from-[#9ec06cff]/10 to-[#7bb033]/50",
    image: "/industries/industrial_machinary.png",
  },
  {
    icon: Server,
    color: "#194479",
  ...
  },
  {
    icon: FileText,
    color: "#91c73e",
    gradient: "from-[#91c73e]/10 to-[#7bb033]/90",
    image: "/industries/high_value.png",
  },
]
