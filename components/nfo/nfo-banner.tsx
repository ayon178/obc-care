...
export default function NfoBanner() {
  const t = useTranslations("NfoBanner")
  ...
  return (
    ...
    >
      {/* gradient overlays */}
      <div className="absolute inset-0 bg-[linear-gradient(to_bottom,rgba(10,26,42,0.85),rgba(10,26,42,0.5)_40%,rgba(10,26,42,0.85))] pointer-events-none" />
